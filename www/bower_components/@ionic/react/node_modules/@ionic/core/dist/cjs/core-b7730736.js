...
const patchBrowser = async () => {
    ...
    // @ts-ignore
    const importMeta = (typeof document === 'undefined' ? new (require('u' + 'rl').URL)('file:' + __filename).href : (document.currentScript && document.currentScript.src || new URL('core-b7730736.js', document.baseURI).href));
...
const global0 = () => {
    ...
    Ionic.mode = defaultMode = config.config.get('mode', (doc.documentElement.getAttribute('mode')) || (config.isPlatform(win, 'ios') ? 'ios' : 'md'));
