...
const Searchbar = class {
    constructor(hostRef) {
         ...
         */
        this.cancelButtonIcon = config.config.get('backButtonIcon', 'arrow-back-sharp');
        /**
    ...
    render() {
        ...
        const cancelButton = (this.showCancelButton !== 'never') && (core.h("button", { "aria-label": "cancel", type: "button", tabIndex: mode === 'ios' && !this.shouldShowCancelButton() ? -1 : undefined, onMouseDown: this.onCancelSearchbar, onTouchStart: this.onCancelSearchbar, class: "searchbar-cancel-button" }, core.h("div", null, mode === 'md'
